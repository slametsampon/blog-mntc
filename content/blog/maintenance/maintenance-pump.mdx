...
| **Spesifikasi Teknis**          |                                                                             |
| Kapasitas (Flow Rate)           | Minimum: [Nilai] m³/h (atau L/min) <br> Maksimum: [Nilai] m³/h (atau L/min) |
| Head (Ketinggian)               | Minimum: [Nilai] m <br> Maksimum: [Nilai] m                                 |
| Tekanan Operasi                 | Maksimum: [Nilai] bar (atau psi) <br> Minimum: [Nilai] bar (atau psi)       |
| Temperatur Cairan               | Maksimum: [Nilai] °C (atau °F) <br> Minimum: [Nilai] °C (atau °F)           |
| Kecepatan Putar                 | [Nilai] RPM                                                                 |
| Efisiensi Pompa                 | [Nilai] % (pada kondisi nominal)                                            |
| Bahan Konstruksi                | Rumah Pompa: [Material] <br> Impeller: [Material] <br> Shaft: [Material]    |
