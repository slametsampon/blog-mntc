...
- [`MWO` is part of `CMMS` system and this module for following task :](#mwo-is-part-of-cmms-system-and-this-module-for-following-task-)
- [Requirements](#requirements)
- [`WO Flowchart`](#wo-flowchart)
- [`WO Class Relationship Diagram`](#wo-class-relationship-diagram)
...
- Describe clear problem for best solution
...
![Sample Work Order][sampleWO]

[sampleWO]: /static/images/workOrder/sampleWO.jpg
...
![Flow Chart][woFlowChart]

[woFlowChart]: /static/images/WoFlowChart.jpg

## `WO Class Relationship Diagram`

![WO Class Diagram][woClassDiagram]

[woClassDiagram]: /static/images/classDiagram/WoDiagram.jpg
